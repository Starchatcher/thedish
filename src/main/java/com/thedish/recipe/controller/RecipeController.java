...
import com.thedish.image.FileStorageService;
import com.thedish.image.Image;
import com.thedish.image.ImageService;
...
public class RecipeController {
	...
	public ModelAndView noticeDetailMethod(@RequestParam("no") int recipeId, ModelAndView mv, HttpSession session) {
